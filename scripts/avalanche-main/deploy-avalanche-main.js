...
const USDT_TOKEN_ADDRESS = '0xc7198437980c041c805a1edcba50c1ce5db95118'

// SPDX-License-Identifier: MIT
async function main() {
  const [deployer] = await ethers.getSigners();
  console.log("Deployed contract on Avalanche MAIN with user ", deployer.address)
  // let token = await deployToken();
  await deployCube(USDT_TOKEN_ADDRESS);
  // await deployVehicle('Polar',USDT_TOKEN_ADDRESS); // https://www.anchorprotocol.com/
  // await deployVehicle('Anchor',USDT_TOKEN_ADDRESS); // https://www.anchorprotocol.com/
  // await deployVehicle('Etherstones',USDT_TOKEN_ADDRESS);// https://etherstones.fi/
