...
const CUBE_ADDRESS = '0xCcECc32caA42A25BAEf6B2A1dBFF2C6C79Adf2cA'
const TOKEN_ADDRESS = '0x020E3EB05a80aB431F37171Fa5Bd0f175E62Ca0F'
const POLAR_NODE = '0x59A974776C25080328A7480Af4EbaD72b9D3dda1'
const ANCHOR = '0x4943Ee1090d92f143E44631DC07aF88f5BE50287'
const ETHERSTONES_NODES= '0x9e937413A629Eb060461589E1Ba8e17A0E41f4Db'
...
async function main() {
    await setInvestmentVehicleForCube(CUBE_ADDRESS, POLAR_NODE, ethers.utils.parseUnits("700.0", 6))
    // await setInvestmentVehicleForCube(CUBE_ADDRESS, YIELD_FARM, ethers.utils.parseUnits("1200.0", 6))
    await makeCubeOwnerOfVehicle(CUBE_ADDRESS, POLAR_NODE)
